...
<head>
    ...
    <link rel="stylesheet" href="/ProyectoSPD/estilos_factura.css">
</head>
<body>
    <div class="menu">
    ...
    <article class="page">
        ...
        <form action="conexion.php" method="post" class="form_cliente">
            ...
            <div class="empresa">
                <label for="Empresa">¿Es una empresa?</label>
            ...
            <input type="hidden" name="Datos"><br><br>
        </form>
    </article>
</body>
</html>