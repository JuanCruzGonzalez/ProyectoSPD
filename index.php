...
<body>
    ...
    <article class="page">
        <div class="contenedor_imagen">
            <h1>Wines Sales</h1>
            <img src="/ProyectoSPD/images/imagen_de_fondo.jpeg" alt="">
        </div>
        <div class="wines_titles">
            <h2 class="list_wines">Lista de Vinos</h2> 
        </div>
        <article class="wines">
            <?php
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        $tipoVino = $row['Tipo de Vino_idTipo de Vino'];
                        $precio = $row['Precio_idPrecio'];
                        ...
                        echo "<br>";
                        echo "Precio: " . $precio;
                        echo '<input type="button" value="Cargar al carrito" class="btn_carrito" onclick="agregarAlCarrito(\'' . $row['Nombre'] . ' - ' . $tipoVino . ' - ' . $precio . '\')">'; // Agregar esta línea
                        echo '</div>';
                    }
                } else {
                    echo "Error ejecutando el query: " . mysqli_error($link);
                }
            ?>
        </article>
    </article>
